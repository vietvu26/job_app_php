            ...
            <div class="row pt-5">
                <div class="col-md-4 col-lg-3 sidebar mb-4">
                    <div class="card border-0 shadow p-4">
                        <div class="mb-4">
                            <h2>Keywords</h2>
                            <input type="text" name="keywords" placeholder="Keywords" class="form-control" value="{{ request('keywords') }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @foreach ($jobTypes as $jobType)
                                <div class="form-check mb-2">
                                    <input class="form-check-input" name="job_types[]" type="checkbox" value="{{ $jobType->id }}" id="job-type-{{ $jobType->id }}" {{ in_array($jobType->id, request('job_types', [])) ? 'checked' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="experience" id="experience" class="form-control">
                                ...
                                @for ($i = 1; $i <= 10; $i++)
                                    <option value="{{ $i }}" {{ request('experience') == $i ? 'selected' : '' }}>{{ $i }} Year{{ $i > 1 ? 's' : '' }}</option>
                                @endfor
